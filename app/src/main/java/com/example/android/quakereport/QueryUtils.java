...
/**
 * Created by ismile on 5/14/2017.
 */
...
public final class QueryUtils {
     ...
     */
    public static ArrayList<EarthquakeInfo> extractEarthquakes(String requesturl) {
        ...
        try {
            ...
            for (int i=0; i < features.length() ; i++){
                ...
                JSONObject propertiesObj = singleFeature.getJSONObject("properties");
                //Date dateObject = new Date(propertiesObj.getLong("time"));
                //SimpleDateFormat dateFormatter = new SimpleDateFormat("MMM DD, yyyy");

                EarthquakeInfo earthquakeInfo = new EarthquakeInfo(
                                                        propertiesObj.getDouble("mag"),
